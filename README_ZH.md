...
一个基于AI的视频转录和摘要工具，支持YouTube、Bilibili等多个视频平台。

## ✨ 功能特性

- 🎥 **多平台支持**: 支持YouTube、Bilibili等yt-dlp支持的所有视频平台
- 🗣️ **智能转录**: 使用Faster-Whisper进行高精度语音转文字
- 🌍 **多语言摘要**: 支持多种语言的智能摘要生成
- 📝 **Markdown输出**: 转录和摘要都以Markdown格式展示和下载
- ⚡ **实时进度**: 实时显示处理进度和状态
- 🎨 **美观界面**: 现代化的响应式Web界面
- 📱 **移动适配**: 完美支持移动设备
...
3. **开始转录**: 点击"开始转录"按钮
4. **查看结果**: 等待处理完成后查看转录文本和智能摘要
5. **下载文件**: 点击下载按钮保存Markdown格式的文件
...
### Q: 支持哪些视频平台？
A: 支持所有yt-dlp支持的平台，包括但不限于：YouTube、Bilibili、优酷、爱奇艺、腾讯视频等。

### Q: 摘要功能不可用怎么办？
A: 摘要功能需要OpenAI API密钥。如果未配置，系统会提供简化版的摘要。
